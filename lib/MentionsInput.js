...
var _getScrollParent = function _getScrollParent(node) {
  if (node === null) {
    return null;
  }
...
var MentionsInput = _react2.default.createClass({
  ...
  renderSuggestionsOverlay: function renderSuggestionsOverlay() {
    ...
    return _react2.default.createElement(_SuggestionsOverlay2.default, {
      className: className,
      style: (0, _extends4.default)({}, this.state.suggestionsPosition, style),
  ...
  updateSuggestionsPosition: function updateSuggestionsPosition() {
    ...
    var scrollParent = _getScrollParent(container);

    if (!suggestions) {
      return;
    }

    var left = caretPosition.left + container.offsetLeft;
    var position = {};
  ...
  handleParentScroll: function handleParentScroll() {
    var _this4 = this;
    ...
    if (!this._ticking) {
      ...
      window.requestAnimationFrame(function () {
        _this4.updateSuggestionsPosition();
  ...
  componentDidUpdate: function componentDidUpdate() {
    this.updateSuggestionsPosition();
    var newScrollParent = _getScrollParent(this.refs.container);
  ...
  addScrollListener: function addScrollListener() {
    var scrollParent = _getScrollParent(this.refs.container);
    if (scrollParent) {
